---
sidebar_position: 7
sidebar_label: Integrating the extension into Selenium using Node.js
---
...
To do this, you need to download the [extension archive](extension-main.mdx).

Unpack the extension and and in the root of the unpacked archive there will be a `defaultSettings.json` file where you can change the settings. [Here](ext-settings.mdx) you can find a description of the parameters.
