...
<TabItem value="proxyless" label="RecaptchaV3TaskProxyless (without proxy)" default className="bordered-panel">
    ...
    **RecaptchaV3TaskProxyless**
    ...
    Version of reCAPTCHA. Supported values: <code>true</code> / <code>false</code> (also <code>1</code> / <code>0</code>, integer type).

    Set <code>true</code> if you want to solve the reCAPTCHA as Enterprise; in this case, the task will be processed the same way as <a href="https://docs.capmonster.cloud/docs/captchas/recaptcha-v3-enterprise-task/" target="_blank">RecaptchaV3EnterpriseTask</a>.
