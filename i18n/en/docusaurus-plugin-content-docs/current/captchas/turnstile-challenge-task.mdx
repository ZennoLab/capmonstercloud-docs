...
Use the [getTaskResult](../api/methods/get-task-result) method to retrieve the Challenge solution. Depending on system load, the response can take between 5 and 20 seconds.
