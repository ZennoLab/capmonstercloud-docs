...
Use the [getTaskResult](../api/methods/get-task-result.mdx) method to get the captcha solution. Depending on the system load, you will receive a response after a time ranging from 300ms to 6s.
