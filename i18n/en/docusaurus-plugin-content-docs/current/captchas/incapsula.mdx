...
<TabItem value="proxyless" label="CustomTask (without proxy)" default className="bordered-panel">
    ...
    **Imperva**
	...
	The returned value must be encoded in base64 format. This will be the value for the parameter incapsulaScriptBase64.
	...
	**Only pass the current UA. The current one is**: Mozilla/5.0 (iPhone; CPU iPhone OS 17_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.5.1 Mobile/21F90 Safari/604.1
</TabItem>
