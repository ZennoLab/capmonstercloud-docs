...
---
  ...
  Base64-encoded HTML page containing `<title>Waiting Room powered by Cloudflare</title>`<br/>
...
Use the [getTaskResult](../api/methods/get-task-result.mdx) method to retrieve the Waiting Room solution. Depending on system load, the response can take between 5 and 20 seconds.
