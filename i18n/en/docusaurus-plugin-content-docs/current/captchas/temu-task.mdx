...
>  IMPORTANT: some parameter values are dynamic — they change with each render of the page using Temu.  
...
Use the [getTaskResult](../api/methods/get-task-result.mdx) method to obtain the Temu solution.
