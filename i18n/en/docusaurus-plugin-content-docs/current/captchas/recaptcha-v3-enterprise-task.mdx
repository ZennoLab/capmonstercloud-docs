...
:::info **Note**
You can also solve reCAPTCHA v3 Enterprise using the reCAPTCHA v3 task type by specifying the `isEnterprise` parameter [(*see the reCAPTCHA v3 section*)](../recaptcha-v3-task/).
:::
