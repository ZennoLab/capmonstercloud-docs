...
Castle is a website protection system that blocks automated attacks and suspicious activity. It monitors user behavior and requests in real time, remaining almost invisible to regular visitors and only becoming noticeable during unusual or high-volume traffic.
...
Link to `csw.js`, for example: ```https://s.rsg.sc/auth/js/20251213bgef/build/csw.js```
