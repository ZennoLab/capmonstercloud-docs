...
### How to find `websiteKey`
Open *Developer Tools*, trigger the CAPTCHA, go to the **Network** tab and find the request that starts with `get?referer=`. The value of the *id* parameter is your `websiteKey`.
