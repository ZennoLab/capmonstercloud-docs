...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  <TabItem value="js" label="JavaScript" default className="method-panel">
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      const geetestV3Request = new GeeTestRequest({
        ...
        gt: '81dc9bdb52d04dc20036dbd8313ed055',       // Replace with actual value
        challenge: 'd93591bdf7860e1e4ee2fca799911215' 
      });

      // Option 2: With proxy (uncomment to use)
      // const geetestV3Request = new GeeTestRequest({
  ...
  <TabItem value="python" label="Python" className="method-panel">
    ...
    # Option 2: With proxy (if the site requires solving from your IP)
    # Uncomment the block below and fill in proxy data
  ...
  <TabItem value="csharp" label="C#" className="method-panel">
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                WebsiteUrl = "https://example.com/demo/geetest", // URL of the page with captcha
                Gt = "your_gt_value",       // Replace with actual value                     
                Challenge = "your_challenge_value"
            };

            // Option 2: With proxy (if needed)
            // Uncomment the block below and fill in proxy data
            /*
            var geetestRequest = new GeeTestRequest
            {
...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  <TabItem value="js" label="JavaScript" default className="method-panel">
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      // Option 1: Solve GeeTest V4 without proxy
      ...
      // Option 2: Solve with proxy (uncomment and fill in details if needed)
      /*
      const geetestV4Request = new GeeTestRequest({
        websiteURL: 'https://example.com/geetest.php',
        gt: '81dc9bdb52d04dc20036dbd8313ed055',
  ...
  <TabItem value="python" label="Python" className="method-panel">
    ...
    geetest_request = GeetestRequest(
        websiteUrl="https://example.com/",  # URL of the page with captcha
        gt="54088bb07d2df3c46b79f80300b0abbe", # Replace with actual value
        version=4,
        initParameters={
            "riskType": "slide" 
        }
