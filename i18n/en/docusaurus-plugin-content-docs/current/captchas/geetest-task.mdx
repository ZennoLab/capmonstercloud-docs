...
<Tabs className="full-width-tabs filled-tabs" groupId="captcha-type">
  <TabItem value="proxy" label="GeeTestTask (using proxy)" className="bordered-panel">
    ...
    **GeeTestTask**
    ...
    <ParamItem title="version" type="integer" />
...
### Get task result request example


 <TabItem value="any" label="GeeTestTaskProxyless (without proxy)" default className="bordered-panel">
:::info Method
```http
...
<TabItem value="any" label="GeeTestTaskProxyless (without proxy)" default className="bordered-panel">
  <ParamItem title="errorId" type="number" response/>
  Error code
  <ParamItem title="status" type="string" response/>
  Status
  <ParamItem title="solution" type="object" response>
    All three parameters are required when submitting the form on the target site.
    <ParamItem title="challenge" type="string" response/> <br />
    <ParamItem title="validate" type="string" response/> <br />
    <ParamItem title="seccode" type="string" response/> <br />
  </ParamItem>
</TabItem>
...
<TabItem value="any" label="GeeTestTaskProxyless (without proxy)" default className="bordered-panel">
  <ParamItem title="errorId" type="number" response/>
  Error code
  <ParamItem title="status" type="ready | " response/>
  Status
  <ParamItem title="solution" type="object" response>
    All five parameters are required when submitting the form on the target site.<br />input[name=captcha_id]<br />input[name=lot_number]<br />input[name=pass_token]<br />input[name=gen_time]<br />input[name=captcha_output]
    <ParamItem title="captcha_id" type="string" response/> <br />
    <ParamItem title="lot_number" type="string" response/> <br />
    <ParamItem title="pass_token" type="string" response/> <br />
    <ParamItem title="gen_time" type="string" response/> <br />
    <ParamItem title="captcha_output" type="string" response/> <br />
  </ParamItem>
</TabItem>
