...
<Tabs className="full-width-tabs">
  <TabItem value="intelligent" label="Intelligent mode" default>
    ![](intelligent.png)
  </TabItem>
  <TabItem value="slide" label="Slide CAPTCHA">
    ![](slide.png)
  </TabItem>
  <TabItem value="icon" label="Icon CAPTCHA">
    ![](icon.png)
  </TabItem>
  <TabItem value="space" label="Space CAPTCHA">
    ![](space.png)
  </TabItem>
</Tabs>
...
<Tabs className="full-width-tabs filled-tabs">
  <TabItem value="intelligent" label="GeeTestTask" className="bordered-panel">
    ...
    **GeeTestTask**
    ...
    <ParamItem title="challenge" required type="string" />
    <p>
  ...
  <TabItem value="slide" label="GeeTestTaskProxyless" default className="bordered-panel">
    <ParamItem title="type" required type="string" />
