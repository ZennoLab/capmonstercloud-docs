...
:::warning **Atenção!**
Por padrão, o CapMonster Cloud usa proxies integrados, portanto você não precisa conectar os seus — o custo já está incluído no preço.  
Use proxies próprios apenas nos casos em que o token não é aceito no site alvo ou o acesso aos serviços integrados é restrito. Você pode entrar em contato com o [suporte](https://helpdesk.zennolab.com/conversation/new) para esclarecer detalhes e verificar como os tokens são aceitos em um site específico.  

Se o seu proxy utilizar autorização por IP, é necessário adicionar o endereço **116.203.55.208** à lista de permissões.
:::
