...
* Use **seus próprios proxies** para executar esta tarefa.
* Se o seu proxy usar autorização baseada em IP, você deve colocar o endereço **116.203.55.208** na lista branca.
* Após resolver, você receberá **cookies especiais** que devem ser adicionados ao navegador.
:::
...
**Forneça apenas um UA válido. Atualmente recomendado**: "userAgentPlaceholder"
...
Use o método [getTaskResult](../api/methods/get-task-result.md) para obter a solução do captcha DataDome.
