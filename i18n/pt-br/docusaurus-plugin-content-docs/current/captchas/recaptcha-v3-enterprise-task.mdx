...
:::info **Observação**
Você também pode resolver o reCAPTCHA v3 Enterprise usando o tipo de tarefa reCAPTCHA v3, especificando o parâmetro `isEnterprise` [(*consulte a seção reCAPTCHA v3*)](../recaptcha-v3-task/).
:::
