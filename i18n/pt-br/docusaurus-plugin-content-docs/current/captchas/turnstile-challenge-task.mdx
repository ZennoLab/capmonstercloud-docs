...
Use o método **[getTaskResult](../api/methods/get-task-result)** para obter a solução do Challenge. Dependendo da carga do sistema, a resposta pode levar entre **5 e 20 segundos**.
