...
<TabItem value="proxyless" label="RecaptchaV3TaskProxyless (sem proxy)" default className="bordered-panel">
   ...
   <ParamItem title="isEnterprise" type="boolean" />
    ...
    Defina `true` se precisar resolver o reCAPTCHA como Enterprise — nesse caso, a tarefa será processada da mesma forma que [RecaptchaV3EnterpriseTask](../recaptcha-v3-enterprise-task/).
