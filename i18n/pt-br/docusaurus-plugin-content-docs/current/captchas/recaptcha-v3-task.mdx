...
Versão do reCAPTCHA. Valores suportados: <code>true</code> / <code>false</code> (também <code>1</code> / <code>0</code>, tipo inteiro).

Defina <code>true</code> se desejar resolver o reCAPTCHA como Enterprise; nesse caso, a tarefa será processada da mesma forma que <a href="https://docs.capmonster.cloud/pt-br/docs/captchas/recaptcha-v3-enterprise-task/" target="_blank">RecaptchaV3EnterpriseTask</a>.
