...
* Utilizar os cookies atualizados para as requisições subsequentes [(veja abaixo exemplos de resolução automática de TSPD)](#exemplos-de-resolucao-automatica-tspd).
