...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    console.log('Saldo:', await cmcClient.getBalance());
    ...
    // Opção 2: com proxy (descomente se necessário)
    /*
    const impervaRequest = new ImpervaRequest({
      websiteURL: 'https://example.com',
      metadata: {
    ...
    */
    ...
    console.log('Solução do Captcha:', result);
  });
````
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var incapsulaSessionCookie = "incap_sess_*=seu_cookie_aqui";
        var reese84UrlEndpoint = "seu_endpoint_reese84_aqui";
        ...
        */
        ...
        Console.WriteLine("Solução Imperva: " + JsonSerializer.Serialize(impervaResult.Solution));
    }
}
```
