...
<TabItem value="proxyless" label="CustomTask (without proxy)" default className="bordered-panel">
    ...
    **Imperva**
    ...
    ---
    <ParamItem title="incapsulaScriptUrl (dentro dos metadados)" required="required" type="string" />
    `"incapsulaScriptUrl": "_Incapsula_Resource?SWJIYLWA=719d34d31c8e3a6e6fffd425f7e032f3"` - Nome do arquivo JS do Incapsula.

    ---

    <ParamItem title="incapsulaCookie (dentro dos metadados)" required type="string" />
    ...
    <ParamItem title="reese84UrlEndpoint (dentro dos metadados)" type="string" />
