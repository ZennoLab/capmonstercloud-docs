...
Use o método [getTaskResult](../api/methods/get-task-result.mdx) para obter a solução do Turnstile. Dependendo da carga do sistema, a resposta pode levar entre 5 e 20 segundos.
...
<Tabs className="full-width-tabs filled-tabs request-tabs">
  <TabItem value="js" label="JavaScript" default className="method-panel">
    <details>
      <summary>Para a Opção 1: Turnstile (token) – no navegador</summary>
    ...
    <details>
      <summary>Para a Opção 2: Challenge (token) – Node.js</summary>
    ...
    <details>
      <summary>Para a Opção 3: Challenge (cookie `cf_clearance`) – Node.js</summary>
  ...
  <TabItem value="python" label="Python" className="method-panel">
    <details>
      <summary>Para a Opção 1: Turnstile (token)</summary>
    ...
    <details>
      <summary>Para a Opção 2: Challenge (token)</summary>
    ...
    <details>
      <summary>Para a Opção 3: Challenge (cookie `cf_clearance`)</summary>
...
<details>
<summary>Opção 1: Turnstile (token)</summary>
...
<details>
<summary>Opção 2: Challenge (token)</summary>
...
<details>
<summary>Opção 3: Challenge (cookie `cf_clearance`)</summary>
...
<details>
<summary>Opção 3: Challenge (cookie <code>cf_clearance</code>)</summary>
