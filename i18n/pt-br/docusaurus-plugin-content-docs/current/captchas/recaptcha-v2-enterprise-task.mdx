---
sidebar_position: 2
sidebar_label: ReCaptchaV2Enterprise
---
...
<TabItem value="proxyless" label="RecaptchaV2EnterpriseTask (sem proxy)" default className="method-panel">
    <MethodItem>
      ```http
...
```
  ...
  <TabItem value="proxy" label="RecaptchaV2EnterpriseTask (com proxy)" className="method-panel">
<MethodItem>
  ```http
  https://api.capmonster.cloud/createTask
  ```
...
Use o método [getTaskResult](../api/methods/get-task-result.mdx) para solicitar a resposta para o ReCaptcha2. Você receberá a resposta em um período de 10 a 80 segundos, dependendo da carga de trabalho do serviço.
