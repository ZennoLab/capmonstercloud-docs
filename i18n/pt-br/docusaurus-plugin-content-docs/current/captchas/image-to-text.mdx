...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  <TabItem value="js" label="JavaScript" default className="method-panel">
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      const imageToTextRequest = new ImageToTextRequest({
        body: 'algum corpo em base64', // Substitua pelo valor correto
  ...
  <TabItem value="python" label="Python" className="method-panel">
    ...
    image_base64 = "/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAgGBgc…wwzqR4U/yZ//Z" # Substitua pelo valor correto
  ...
  <TabItem value="csharp" label="C#" className="method-panel">
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                Body = "/9j/4AAQSkZJRgABAQAAAQABA...hMjIyMjIyMjIyMjIyMj", // Substitua pelo valor correto
            ...
            Console.WriteLine("Captcha Resolvido: " + imageToTextResult.Solution.Value);
        }
    }
    ```
  </TabItem>
