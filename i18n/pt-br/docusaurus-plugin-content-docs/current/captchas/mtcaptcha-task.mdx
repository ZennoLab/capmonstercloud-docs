...
:::warning **Atenção!**
Por padrão, o CapMonster Cloud usa servidores proxy integrados.
Se necessário, você pode configurar proxies próprios para garantir funcionamento estável e compatibilidade, caso o acesso aos serviços integrados esteja restrito.
:::
...
**Informe apenas um UA atual do Windows. Atualmente válido:** userAgentPlaceholder
