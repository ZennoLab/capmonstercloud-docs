...
> Veja exemplos de extração automática de parâmetros nas seções [Como obter meta.token](#como-obter-metatoken) e [Exemplo de resolução do Hunt CAPTCHA](#exemplo-de-resolução-do-hunt-captcha).
</span>
<br />
...
Também é importante utilizar **cabeçalhos HTTP atualizados e um [`User-Agent` correto](https://capmonster.cloud/api/useragent/actual)**.
