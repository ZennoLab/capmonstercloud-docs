...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    const yidunRequest = new YidunRequest({
      ...
      websiteKey: '6cw0f0485d5d46auacf9b735d20218a5', // Substitua pelo valor correto
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        // Opção 1: Yidun sem proxy
        var yidunRequest = new YidunTaskRequest
        {
            WebsiteUrl = "https://example.com", // URL da página com captcha 
            WebsiteKey = "7ce0f0475b5d46acacf9b732a29218d9", // Substitua pelo valor correto
            UserAgent = "userAgentPlaceholder" // Use o UserAgent atual
        };

        // Opção 2: Yidun com proxy
        // Descomente se precisar usar um proxy
        /*
        var yidunRequest = new YidunTaskRequest
        {
        ...
        */
        ...
        Console.WriteLine("Solução Yidun: " + yidunResult.Solution.Value);
    }
}
```
