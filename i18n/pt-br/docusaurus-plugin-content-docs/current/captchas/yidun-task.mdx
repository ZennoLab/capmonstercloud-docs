...
### Como obter o `websiteKey`
Abra as *Ferramentas de desenvolvedor*, ative o CAPTCHA, vá até a aba **Network** e encontre uma requisição que começa com `get?referer=`. O valor do parâmetro *id* é o seu `websiteKey`.
