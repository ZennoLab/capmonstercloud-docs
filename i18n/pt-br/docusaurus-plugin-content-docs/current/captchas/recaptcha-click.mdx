...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  <TabItem value="js" label="JavaScript" default className="method-panel">
    ...
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      const complexImageRecaptchaRequest = new ComplexImageRecaptchaRequest({
        imageUrls: ['https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg'], // Substitua pelo valor correto
        metaData: {
          Grid: '3x3', 
          Task: 'Por favor clique em cada imagem que contenha uma montanha',
          TaskDefinition: '/m/015qff',
        },
        websiteURL: 'https://lessons.zennolab.com/captchas/recaptcha/v2_simple.php?level=middle', // URL da página com captcha 
      });
  ...
  <TabItem value="python" label="Python" className="method-panel">
    ...
    complex_image_recaptcha_request = RecaptchaComplexImageTaskRequest(
        imagesUrls=["https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg"],  # Substitua pelo valor correto
        metadata={
            "Task": "Clique nos semáforos",
            "Grid": "3x3",
            "TaskDefinition": "/m/015qff",
            "websiteUrl": "https://lessons.zennolab.com/captchas/recaptcha/v2_simple.php?level=middle",  # URL da página com captcha 
        }
  ...
  <TabItem value="csharp" label="C#" className="method-panel">
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            {
                ImageUrls = new[] { "https://i.postimg.cc/yYjg75Kv/payloadtraffic.jpg" }, // Substitua pelo valor correto
            ...
            Console.WriteLine("Solução do Captcha: " + string.Join(", ", complexImageRecaptchaResult.Solution.Answer));
        }
    }
    ```
