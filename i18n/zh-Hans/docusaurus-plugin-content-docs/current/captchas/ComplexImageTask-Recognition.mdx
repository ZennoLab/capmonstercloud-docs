...
<TaskImageWrapper>
  <TaskImageBlock link="/zh-Hans/docs/captchas/ComplexImageTask-Recognition#oocl_rotate_new">
    <TaskImage>
      ![](./images/ComplexImageTask-Recognition/oocl_img.png)
    </TaskImage>
    <TaskImageText title="Oocl_rotate_new" price={0.3} />
  </TaskImageBlock>
  <TaskImageBlock link="/zh-Hans/docs/captchas/ComplexImageTask-Recognition#oocl_rotate_double_new">
    <TaskImage>
      ![](./images/ComplexImageTask-Recognition/oocl_rotate_img.png)
    </TaskImage>
    <TaskImageText title="Oocl_rotate_double_new" price={0.3} />
  </TaskImageBlock>
  <TaskImageBlock link="/zh-Hans/docs/captchas/ComplexImageTask-Recognition#betpunch_3x3_rotate">
    <TaskImage>
      ![](./images/ComplexImageTask-Recognition/betpunch_img.png)
    </TaskImage>
    <TaskImageText title="Betpunch_3x3_rotate request" price={0.3} />
  </TaskImageBlock>
  <TaskImageBlock link="/zh-Hans/docs/captchas/ComplexImageTask-Recognition#bls">
    <TaskImage>
