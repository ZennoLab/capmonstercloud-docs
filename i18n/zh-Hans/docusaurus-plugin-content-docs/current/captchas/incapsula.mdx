...
<TabItem value="proxyless" label="CustomTask (without proxy)" default className="bordered-panel">
    ...
    **Imperva**
	...
	返回的值必须编码为 base64 格式。这将是参数 incapsulaScriptBase64 的值。
	...
	浏览器的 User-Agent。 <br />
	**仅传递 Windows 操作系统的当前 UA。目前的 UA 是**： Mozilla/5.0 (iPhone; CPU iPhone OS 17_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.5.1 Mobile/21F90 Safari/604.1
</TabItem>
