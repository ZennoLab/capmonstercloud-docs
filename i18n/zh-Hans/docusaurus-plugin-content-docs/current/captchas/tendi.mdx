...
|userAgent|String|否|浏览器用户代理。**仅传递来自Windows操作系统的实际UA。现在这是126版本**： `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36`|
