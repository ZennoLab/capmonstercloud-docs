---
sidebar_position: 7
sidebar_label: 将扩展程序集成到 Selenium 中使用 Node.js
---
...
为此，您需要下载[扩展程序压缩包](extension-main.mdx)。

解压扩展程序，在解压后的根目录中会有一个`defaultSettings.json`文件，您可以在其中更改设置。[这里](ext-settings.mdx)可以找到参数的描述。
