...
<figcaption>挑战无缝集成在网站中</figcaption>
...
<figcaption>看起来像普通的 Turnstile 验证码，但实际上是 Cloudflare 挑战</figcaption>

</figure>

要确认是否存在 Cloudflare，可以打开开发者工具，检查网络流量，并在页面源码中寻找典型标志：
