...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    const prosopoRequest = new ProsopoRequest({
      ...
      websiteKey: '5EZU3LG31uzq1Mwi8inwqxmfvFDpj7VzwDnZwj4Q3syyxBwV' // 替换为正确值
      /*
      // 如果需要使用代理:
      proxy: {
        type: 'http',
...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var prosopoRequest = new ProsopoTaskRequest
        {
            ...
            WebsiteKey = "5DCKg3w9AvDW92uBzRWrvTiWsu573bTzYmFny8EkXQZxsBib" // 替换为正确值
        };
        ...
        */
        ...
        Console.WriteLine("Prosopo 解决方案: " + JsonSerializer.Serialize(prosopoResult.Solution.Value));
    }
}
```
