...
<BlogLink url="https://blog.capmonster.cloud/zh/blog/re-1/how-to-bypass-recaptcha-v2-using-capmonster-cloud"/>
...
<Tabs className="full-width-tabs filled-tabs" groupId="captcha-type">
  <TabItem value="proxyless" label="RecaptchaV2TaskProxyless (无代理)" default className="bordered-panel">
