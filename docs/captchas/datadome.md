...
|metadata|Object|да|На Ваш выбор одно из значений: "htmlPageBase64": "..." либо `"captchaUrl"` <br /> Объект, который содержит дополнительные данные о капче: `"htmlPageBase64": "..."` - закодированная в base64 html страница, которая приходит с кодом 403 и заголовком Set-Cookie: datadome="..." в ответ на get запрос к целевому сайту. <br /> `"captchaUrl"` -  ссылка на капчу. Обычно имеет вид `"https://geo.captcha-delivery.com/captcha/?initialCid=..."`. <br /> `"datadomeCookie"` - Ваши куки от datadome. Можно получить на странице с помощью "document.cookie" или в заголовке запроса Set-Cookie: "datadome=..." (см. пример запроса /createTask)|
