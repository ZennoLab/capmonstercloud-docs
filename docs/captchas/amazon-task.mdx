...
:::warning **Внимание!**
По умолчанию CapMonster Cloud использует встроенные прокси, поэтому вам не нужно подключать свои — их стоимость уже включена в цену.
...
Если прокси с авторизацией по IP, то необходимо добавить адрес **116.203.55.208** в белый список.
:::
...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  ...
  <TabItem value="proxy" label="AmazonTask (с использованием прокси)" className="method-panel">
    <MethodItem>
      ```http
      https://api.capmonster.cloud/createTask
      ```
