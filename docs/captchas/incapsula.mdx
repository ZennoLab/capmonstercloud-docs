		...
		<TabItem value="csharp" label="C#" className="method-panel">
			...
			class Program
			{
				static async Task MainImperva(string[] args)
				{
					...
					var impervaRequest = new ImpervaCustomTaskRequest(incapsulaScriptBase64: "dmFyIF8weGQ2ZmU9Wydce..eDUzXHg2YVx4NGYnKV09XzB4Mjk3MTIxO319KCkpOw==", incapsulaSessionCookie: "l/LsGnrvyB9lNhXI8borDKa2IGcAAAAAX0qAEHheCWuNDquzwb44cw=", reese84UrlEndpoint: "Built-with-the-For-hopence-Hurleysurfecting-the-")
					{
						WebsiteUrl = "https://example.com",
