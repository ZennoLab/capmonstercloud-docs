...
<TabItem value="proxyless" label="CustomTask (без прокси)" default className="bordered-panel">
    ...
    **Incapsula**
    ...
    `"incapsulaScriptBase64": "..."` - закодированное в base64 содержимое js скрипта инкапсулы

    ---

    <ParamItem title="metadata.incapsulaSessionCookie" required type="string" />
    Ваши куки от incapsula. Можно получить на странице с помощью "document.cookie" или в заголовке запроса Set-Cookie: "incap_sess_*=..." (см. пример запроса /createTask)
