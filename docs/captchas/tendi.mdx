...
:::warning **Внимание!**
По умолчанию задача будет решаться через прокси самого сервиса.
Однако вы можете указать свои прокси - они будут использованы, если прокси сервиса станут недоступны. Это позволяет не менять API-логику при сбоях.
:::
