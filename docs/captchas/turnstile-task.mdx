...
:::info Важно:
Перед началом работы изучите все три варианта распознавания капчи и выберите тот, который лучше всего соответствует вашим потребностям.
:::
...
:::warning **Внимание!**
* Для выполнения данной задачи использование ваших прокси **не требуется**.
