...
<PriceBlockWrap>
  <PriceBlock title="Turnstile" captchaId="cf-turnstile"/>
  <PriceBlock title="Challenge" captchaId="cf-turnstile"/>
  <PriceBlock title="WaitingRoom" captchaId="cf-turnstile"/>
</PriceBlockWrap>
...
<Tabs className="full-width-tabs filled-tabs request-tabs" groupId="captcha-type">
  <TabItem value="js" label="JavaScript (для браузера)" default className="method-panel">
...
<details>
<summary>Вариант 3. Challenge (cookie <code>cf_clearance</code>)</summary>
