...
```js
import { gotScraping } from "got-scraping"; // Для выполнения HTTP-запросов с TLS-отпечатком
import fs from "fs";
...
from curl_cffi.requests import AsyncSession # Для выполнения HTTP-запросов с TLS-отпечатком
