...
:::warning **Внимание!**
При работе с целевым сайтом следует учитывать, что он может использовать специальные **cookies** для управления пользовательской сессией, проверки антибот-механизмов и согласования запросов. Если необходимые cookies отсутствуют или не передаются вместе с API-запросами, сервер может отклонить запрос, вернуть ошибку или снова потребовать прохождение проверки.
:::
...
Также важно использовать **актуальные HTTP‑заголовки и корректный `User-Agent`**.
