...
> Примеры автоматического извлечения параметров см. в разделе [Как получить meta.token](#как-получить-metatoken) и [Пример решения Hunt CAPTCHA](#пример-решения-hunt-captcha) .
</span>
<br />
...
**Важно:** Используйте **актуальные HTTP‑заголовки и [корректный `User-Agent`](https://capmonster.cloud/api/useragent/actual)**.
