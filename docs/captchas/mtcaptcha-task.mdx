...
При необходимости вы можете задать собственные прокси для обеспечения стабильной работы и сохранения совместимости, если доступ к встроенным сервисам будет ограничен.
:::
