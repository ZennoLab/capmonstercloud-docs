...
>  ВАЖНО: получайте htmlPageBase64 непосредственно перед созданием задачи, чтобы избежать ошибок при решении (см. пример получения htmlPageBase64 ниже).
</span>
<br />
...
<TabItem value="proxyless" label="RecaptchaV2EnterpriseTaskProxyless (without proxy)" default className="bordered-panel">
  ...
  **wait_room**
  ...
  HTML-страница в **формате base64**, на которой присутствует заголовок `<title>Waiting Room powered by Cloudflare</title>`<br/> 
