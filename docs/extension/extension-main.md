...
1. Откройте [Интернет-магазин Chrome](https://brocapgpt.com).
...
4. Либо перейдите в настройки Google Chrome и справа в меню выберите пункт “Расширения” (в самом низу)

  ![](Aspose.Words.d14847ca-5ce8-4c9f-8081-1ec99b44a6b3.005.png)

5. Включите “Режим разработчика”
6. Снизу появится новое меню в котором нужно выбрать кнопку “Загрузить распакованное расширение”. 

  ![](Aspose.Words.d14847ca-5ce8-4c9f-8081-1ec99b44a6b3.006.png)

7. Появится стандартный для Вашей ОС диалог поиска файлов/директорий, отыщите и выберете папку, в которую распаковали архив.
8. После этого расширение должно появиться в списке установленных
...
Здесь Вы можете выбрать, как разгадывать FunCaptcha – с помощью токенов или кликов.
...
|**Фильтр**|**Пояснение**|
| :-: | :-: |
|`https://brocapgpt.com`|Запрет работы расширения на сайте `https://brocapgpt.com`|
|`https://*.brocapgpt.com`|Запрет работы расширения на всех поддоменах `https://brocapgpt.com`|
